        ...
        new Category {
            ...
            BannerImageUrl = "/image/baseballBanner.jpg", Products =
            {
                new Product{
                    ...
                    ProductSizes =
                    {
                        new ProductSize { ID = 1, Size = "Small" },
                        new ProductSize { ID = 2, Size = "Medium" },
                        new ProductSize { ID = 3, Size = "Large" }
                    }, Reviews =
                    {
                        new Review{ ID = 1, Rating = 5, Text = "I love this hat"},
                        new Review{ ID = 2, Rating = 1, Text = "I hate this hat"}
                    },
                    ProductImages =
                    {
                        new ProductImage{ ID = 1, Url = "/image/hat1.png", AltText="Hat 1"}
                    }
                }
            }
        },
