...
namespace HatShop.Data.Migrations
{
    ...
    [Migration("20190327185936_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HatShop.Data.Order", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HatShop.Data.OrderItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HatShop.Data.Order", b =>
                {
                    b.HasOne("HatShop.Data.HatUser", "HatUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HatShop.Data.OrderItem", b =>
                {
                    b.HasOne("HatShop.Data.Order", "Order")
                        .WithMany("OrderItems")
